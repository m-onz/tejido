defmodule Tajido.Harmony do
  ...
  ## Examples
      iex> Tajido.Harmony.constrain_to_scale("60 63 65 68", :major, "C")
      "60 64 65 67"  # Maps to C major scale
      
      iex> Tajido.Harmony.constrain_to_scale("60 63 65 68", :minor, "C")
      "60 63 65 67"  # Maps to C minor scale
      
      iex> Tajido.Harmony.constrain_to_scale("- 61 - 66", :major, "C")
  ...
  def constrain_to_scale(pattern, scale_type, root) do
    ...
    scale_degrees = Tajido.Scales.scale_degrees(scale_type)
    
    # Get the root note semitone value
    root_semitone = Tajido.Scales.note_name_to_semitone(root)
  ...
  ## Examples
      ...
      iex> Tajido.Harmony.constrain_to_chord("60 62 65 68", :minor7, "C")
  ...
  def constrain_to_chord(pattern, chord_type, root) do
    ...
    chord_intervals = Tajido.Scales.chord_intervals(chord_type)
  ...
  ## Examples
      ...
      iex> Tajido.Harmony.harmonic_sequence(pattern, chords, position: 1)
  ...
  ## Examples
      iex> Tajido.Harmony.constrain_to_intervals("60 62 66 69", 60, [0, 4, 7, 12])
      "60 60 67 72"  # Only allows unison, major third, fifth and octave
      
      iex> Tajido.Harmony.constrain_to_intervals("- 61 - 72", 60, [0, 3, 7, 10])
  ...
  ## Examples
      ...
      iex> Tajido.Harmony.tension("60 62 65 67", 60, 1.0)  # Full tension
      "61 66 70 73"  # Maps to tense intervals: minor second, tritone, minor seventh
      
      iex> Tajido.Harmony.tension("60 62 65 67", 60, 0.5)  # Balanced
  ...
  ## Examples
      ...
      iex> Tajido.Harmony.chord_voicing("C", :major7, style: :spread)
      "48 64 67 83"  # Spread voicing with wider intervals
      
      iex> Tajido.Harmony.chord_voicing("C", :major7, style: :drop2)
  ...
  def chord_voicing(root, chord_type, opts \\ []) do
    ...
    # Get chord intervals
    chord_intervals = Tajido.Scales.chord_intervals(chord_type)
    root_midi = Tajido.Scales.note_to_midi("#{root}4")
