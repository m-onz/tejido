defmodule Tajido.Parameters do
  @moduledoc """
  Adds support for parameter modifiers to Tajido patterns.
  ...
  ## Examples
      iex> Tajido.Parameters.parse("60@0.8 64@0.5 67@1.0")
  ...
  ## Examples
      iex> Tajido.Parameters.format(%{notes: "60 64 67", velocities: "0.8 0.5 1.0"})
      "60@0.8 64@0.5 67@1.0"
      
      iex> Tajido.Parameters.format(%{notes: "60 64 67", durations: "2 1 0.5"})
      "60:2 64:1 67:0.5"
      
      iex> Tajido.Parameters.format(%{notes: "60 64 67", velocities: "0.8 0.6 1.0", durations: "2 1 0.5"})
  ...
  ## Examples
      ...
      iex> pattern = "60@0.8:2 64@0.6:1 67@1.0:0.5"
      iex> Tajido.Parameters.transform_param(pattern, :velocities, &Tajido.scale(&1, 0.5))
      "60@0.4:2 64@0.3:1 67@0.5:0.5"
      
      iex> pattern = "60@0.8:2 64@0.6:1 67@1.0:0.5"
      iex> Tajido.Parameters.transform_param(pattern, :durations, &Tajido.scale(&1, 2))
  ...
  ## Examples
      iex> Tajido.Parameters.get_param("60@0.8:2 64@0.6:1 67@1.0:0.5", :notes)
      "60 64 67"
      
      iex> Tajido.Parameters.get_param("60@0.8:2 64@0.6:1 67@1.0:0.5", :velocities)
      "0.8 0.6 1.0"
      
      iex> Tajido.Parameters.get_param("60@0.8:2 64@0.6:1 67@1.0:0.5", :durations)
      "2 1 0.5"
  """
