defmodule Tajido.Scales do
  @moduledoc """
  Provides musical scale and chord definitions for Tajido.
  ...
  ## Examples
      iex> Tajido.Scales.scale_degrees(:major)
      [0, 2, 4, 5, 7, 9, 11]
      
      iex> Tajido.Scales.scale_degrees(:minor)
      [0, 2, 3, 5, 7, 8, 10]
  """
  ...
  ## Examples
      iex> Tajido.Scales.chord_intervals(:major)
      [0, 4, 7]
      
      iex> Tajido.Scales.chord_intervals(:dominant7)
      [0, 4, 7, 10]
  """
  ...
  ## Examples
      iex> Tajido.Scales.note_name_to_semitone("C")
      0
      
      iex> Tajido.Scales.note_name_to_semitone("F#")
      6
  """
  ...
  ## Examples
      iex> Tajido.Scales.degree_to_semitone(1, :major)
      0
      
      iex> Tajido.Scales.degree_to_semitone(5, :major)
      7
  """
  ...
  ## Examples
      ...
      iex> Tajido.Scales.scale_pattern("1 2 3 4 5", :pentatonic_minor)
      "0 3 5 7 10"
  """
  def scale_pattern(pattern, scale) do
    Tajido.transform(pattern, fn note ->
      case note do
        "-" -> "-"  # Preserve rests
        n ->
  ...
  ## Examples
      iex> Tajido.Scales.to_midi_note(0, "C", 4)
      60
      
      iex> Tajido.Scales.to_midi_note(4, "G", 3)
      59
  """
  ...
  ## Examples
      iex> Tajido.Scales.to_midi_pattern("0 4 7", "C", 4)
      "60 64 67"
      
      iex> Tajido.Scales.to_midi_pattern("0 3 7", "F", 3)
      "53 56 60"
  """
  ...
  ## Examples
      iex> Tajido.Scales.chord(:major, "C")
      "0 4 7"
      
      iex> Tajido.Scales.chord(:minor7, "A")
      "0 3 7 10"
  """
  ...
  ## Examples
      ...
      iex> Tajido.Scales.parse_chords("i iv v", :minor, "A")
  ...
  ## Examples
      iex> Tajido.Scales.note_to_midi("C4")
      60
      
      iex> Tajido.Scales.note_to_midi("F#3")
      54
  """
  ...
  ## Examples
      iex> Tajido.Scales.midi_to_note(60)
      "C4"
      
      iex> Tajido.Scales.midi_to_note(66)
      "F#4"
  """
  ...
  ## Examples
      ...
      iex> Tajido.Scales.notes_to_midi("F3 - A3")
      "53 - 57"
  """
  ...
  ## Examples
      ...
      iex> Tajido.Scales.midi_to_notes("53 - 57")
      "F3 - A3"
  """
