defmodule Tejido.Generators do
  @moduledoc """
  Implements advanced pattern generation algorithms for Tejido.
  ...
  ## Examples
      ...
      iex> Tejido.Generators.palindrome("1 2 3", include_middle: false)
      "1 2 3 2 1"
      
      iex> Tejido.Generators.palindrome("1 2 3", include_middle: true)
      "1 2 3 3 2 1"
  """
  def palindrome(pattern, opts \\ []) do
    include_middle = Keyword.get(opts, :include_middle, false)
    
    elements = pattern |> Tejido.parse() |> String.split(" ")
  ...
  ## Examples
      ...
      iex> Tejido.Generators.stutter("1 2 3", [3, 2, 1])
      "1 1 1 2 2 3"
      
      iex> Tejido.Generators.stutter("1 - 3", 2)
      "1 1 - - 3 3"
  """
  ...
  ## Examples
      ...
      iex> Tejido.Generators.expand_stutter("1!3 - 3!2")
      "1 1 1 - 3 3"
  """
  ...
  ## Examples
      ...
      iex> Tejido.Generators.weighted_choice([{"-", 0.2}, {"60", 0.5}, {"67", 0.3}], count: 5, seed: 456)
      "60 67 60 60 -"
  """
  ...
  ## Examples
      ...
      iex> Tejido.Generators.l_system("a", [{"a", "a b"}, {"b", "a"}], 3)
      "a b a"
  """
  ...
  ## Examples
      ...
      iex> Tejido.Generators.polyrhythm(["1 2", "a b c d"], [2, 4])
      "1 a 2 b - c - d"
  """
